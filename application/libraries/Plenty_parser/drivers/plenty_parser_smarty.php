...
class Plenty_parser_smarty extends CI_Driver {
    ...
    public function __construct()
    {
       ...
       // require_once APPPATH."third_party/Smarty/Smarty.class.php";
        require_once $_SERVER['DOCUMENT_ROOT']."/admin/modules/smarty/libs/Smarty.class.php";
        ...
        $this->_smarty->left_delimiter  = config_item('parser.smarty.left_delimiter'); 
		$this->_smarty->right_delimiter = config_item('parser.smarty.right_delimiter');
